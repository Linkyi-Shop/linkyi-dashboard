        ...
        <div class="layout-specing">
            ...
            <div class="row mt-4">
                <div class="col-12 bg-white shadow rounded p-4">
                    <form action="{{ route('theme.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div>
                                            <label for="path" class="form-label">Path Tema <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="@error('path') is-invalid @enderror form-control"
                                                id="path" name="path" value="{{ old('path') ?? $data->path }}"
                                                placeholder="Nama tema">
                                            @error('path')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select name="is_premium" class="form-control form-control" id="is_premium">
                                            <option {{ $data->is_premium == 1 ? 'selected' : '' }} value="1">
                                                Premium
                                            </option>
                                            <option {{ $data->is_premium == 0 ? 'selected' : '' }} value="0">
                                                Gratis
                                            </option>
                                        </select>
                                        @error('is_premium')
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text"
                                            ...
                                            id="price" name="price" {{ $data->is_premium == 0 ? 'disabled' : '' }}
                                            value="{{ $data->price == 0 ? '' : $data->getPrice() }}" placeholder="Rp 0">
                                        @error('price')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
